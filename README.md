...
# Desafio 4 - ReactJS + Vite - TicTacToe
...
# Desafio 5 - A Famigerada API Pokemon (Axios)

- Consuma a API https://pokeapi.co/api/v2/pokemon e liste todos os Pokemons.
- Exibir imagem, nome e experiencia.
- Ordenar por nome.
